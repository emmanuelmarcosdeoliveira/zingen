...
<div align="center">
<img alt="Astro" width="24" height="35" src=".//public/github/astro_dark.svg " /></br>
...
![GitHub top language](https://img.shields.io/github/languages/top/emmanuelmarcosdeoliveira/zingen?style=plastic&labelColor=%23000)
![GitHub language count](https://img.shields.io/github/languages/count/emmanuelmarcosdeoliveira/zingen?style=flat&logo=github&logoColor=%23fff&logoSize=auto&labelColor=%23000)
![GitHub repo size](https://img.shields.io/github/repo-size/emmanuelmarcosdeoliveira/zingen?style=plastic&logo=github&logoColor=%23fff&logoSize=auto&labelColor=%23000)
![GitHub forks](https://img.shields.io/github/forks/emmanuelmarcosdeoliveira/zingen?style=plastic&labelColor=%23000)
...
- Desenvolver uma landing-page de uma aplicativo de Música.

`Charlenge`

Os Maiores desafios foram:<br>
trabalhar com bordar degrade e construção de uma aplicação responsiva com o **framework** _AstroJs_.

### Functionalities

- [x] **Landing-page de aplicativo de Música**
...
```bash
git clone https://github.com/emmanuelmarcosdeoliveira/zingen
```
